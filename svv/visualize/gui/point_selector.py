...
class PointSelectorWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        group_box = QGroupBox(f"{CADIcons.POINT} Start Points & Directions")
        ...
        self.pick_mode_btn = QPushButton(f"{CADIcons.POINT} Pick Point (Click on Domain)")
        ...
        self.manual_btn = QPushButton(f"{CADIcons.PLUS} Manual Input...")
        ...
        # Direction checkbox
        self.use_direction_cb = QCheckBox(f"{CADIcons.ARROW} Use Custom Direction")
        ...
        self.delete_btn = QPushButton(f"{CADIcons.MINUS} Delete Selected")
        self.delete_btn.clicked.connect(self._delete_selected)
        self.delete_btn.setObjectName("dangerButton")
        self.delete_btn.setToolTip("Delete the currently selected point")
        action_layout.addWidget(self.delete_btn)

        self.clear_btn = QPushButton(f"{CADIcons.CROSS} Clear All")
    ...
    def _toggle_pick_mode(self, checked):
        ...
        if checked and self.parent_gui:
            self.pick_mode_btn.setText(f"{CADIcons.POINT} Picking... (Click Domain)")
            ...
            self.pick_mode_btn.setText(f"{CADIcons.POINT} Pick Point (Click on Domain)")
