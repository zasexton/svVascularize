...
<!-- smoke-test-badge -->
[![SVV passing](https://img.shields.io/badge/svv_passing-linux_ok-macos_ok-windows_fail-red)](https://github.com/zasexton/svVascularize/actions/workflows/basic-smoke-test.yml?query=branch%3Amain)
<!-- /smoke-test-badge -->
